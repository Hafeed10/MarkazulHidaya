...
function HomeOne() {
  return (
    <div className='relative w-full h-auto flex flex-col -z-50 py-12 md:p-16 lg:py-20 xl:py-32 pb-20 md:pb-40 lg:pb-64 xl:pb-80  px-3 md:px-10 lg:px-10 xl:px-36 space-y-7 lg:space-y-10 xl:space-y-12 items-center justify-center text-center'>
        ...
        <p class="md:px-8 lg:px-16 xl:px-24 text-center text-[#555555] text-base md:text-xl  lg:text-2xl font-light leading-snug tracking-wide">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. versions of Lorem Ipsum.</p>
