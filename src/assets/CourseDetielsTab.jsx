        ...
        >
          {Tabs.map((tab) => (
            <li key={tab.tabKey} className="text-center cursor-pointer">
              <button
                className={`hover:text-[#CCA65D] text-[#CCA65D]  ${
      ...
      <div className={`w-full py-12 h-full`} id={activeTab}>
        {activeTab === "AboutCourse" && (
          <div className="flex flex-col items-center md:items-start text-center w-full h-full gap-8 md:gap-6   md:text-start">
            <div className="flex flex-col md:flex-row  items-center justify-start w-full gap-5 md:gap-10 ">
              ...
              <div className="flex items-center gap-4 md:gap-6">
                <div className=" text-[#555555] justify-center  cursor-pointer w-auto font-normal px-3 lg:px-4 space-x-1.5 flex items-center  py-1 bg-[#CDCDCD] rounded-lg ">
                  ...
                  <p class=" text-sm lg:text-base  font-sans tracking-wide">
                    2 weeks
                  </p>
                </div>
                <div className=" text-[#555555] justify-center  cursor-pointer w-auto font-normal px-3 lg:px-4 space-x-1.5 flex items-center  py-1 bg-[#CDCDCD] rounded-lg ">
            ...
            <p className="pb-2 font-sans xs:text-base sm:text-lg  lg:text-xl">
              ...
              institution rendering socio cultural and educational service to
              the Kerala Society. It stands as a praiseworthy establishment to
              mould a new generation having high academic values, IT Tricks,
              soft skills and deep knowledge in theology and Islamic studies.
              The Major Institutions are Hifzul Qur'an college, College of Arts
              And Islamic studies, Moulana English Medium School, Institute of
              Tailoring and Embroidery, Computer Centre, Boarding madarasa for
              boys, Care for orphans and destitute, Science Lab, Masjid, Library
              and Reading Room and Charitable Activities.
            </p>
            <div className="justify-center  cursor-pointer w-auto px-4 lg:px-6 flex items-center  py-1.5 lg:py-2 bg-[#ffb134] rounded-md lg:rounded-lg">
              <p class="text-white text-base font-normal font-sans tracking-wide">
                Apply Now
              </p>
            </div>
          </div>
        ...
        {activeTab === "Syllabus" && (
          <div className="flex flex-col items-start w-full h-full gap-6 md:gap-8 text-start">
            ...
            <ul className=" font-sans text-base md:text-lg list-disc list-inside">
              ...
              <li>
                Terms such as Components, Constraints & Multi Dimensional
                Variants.
              </li>
              <li>
              ...
              <li>
                How to make both simple & advanced micro interactions, page
        ...
        {activeTab === "instructor" && (
          <div className="flex flex-col md:flex-row items-start w-full h-full gap-8 md;gap-10 lg:p-12">
            <img
              src={instructorImg}
              className="w-full md:auto object-cover h-80 md:h-auto rounded-xl lg:rounded-3xl"
              alt=""
            />
            <div className="flex flex-col items-start w-full h-full gap-4 md:gap-6 text-start">
              ...
              <p className="font-sans text-base lg:text-lg xl:text-xl">
                Markazul Hidayathil Islamiyya, established in the year 1996, is
                a unique centre of education comprising of more than 12
                institutions with nearly thousand students on the rolls. It is
                pioneer institution rendering socio cultural and educational
                service to the Kerala Society. It stands as a praiseworthy
                establishment to mould a new generation having high academic
                values, IT Tricks, soft skills and deep knowledge in theology
                and Islamic studies. The Major Institutions are Hifzul Qur'an
                college, College of Arts And Islamic studies, Moulana English
                Medium School, Institute of Tailoring and Embroidery, Computer
                Centre, Boarding madarasa for boys, Care for orphans and
